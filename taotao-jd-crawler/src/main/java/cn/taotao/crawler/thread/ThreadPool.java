package cn.taotao.crawler.thread;
...
import cn.taotao.crawler.Main;
import cn.taotao.crawler.service.PropertieService;
...
public class ThreadPool {
	...
	private static final AbortPolicy HANDLER = new AbortPolicy();
