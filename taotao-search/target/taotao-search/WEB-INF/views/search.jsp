...
<%
	String url = "http://static.taotao.com";
...
<link rel="stylesheet" type="text/css" href="${baseUrl}/css/psearch20131008.css" media="all" />
<link rel="stylesheet" type="text/css" href="${baseUrl}/css/psearch.onebox.css" media="all" />
<link rel="stylesheet" type="text/css" href="${baseUrl}/css/pop_compare.css" media="all" />
<script type="text/javascript" src="${baseUrl}/js/jquery-1.2.6.min.js"></script>
</head>
<body>
<script type="text/javascript" src="${baseUrl}/js/base-2011.js" charset="utf-8"></script>
<!-- header start -->
...
<!-- footer end -->
<script type="text/javascript" src="${baseUrl}/js/jquery.hashchange.js"></script>
<script type="text/javascript" src="${baseUrl}/js/search_main.js"></script>
