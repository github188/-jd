...
%>
<script type="text/javascript" src="${baseUrl}/js/base-v1.js" charset="utf-8"></script>
<!--shortcut start-->
<jsp:include page="../commons/shortcut.jsp" />
<!--shortcut end-->
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.taotao.com/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="${baseUrl}/images/taotao-logo.gif" width="270" height="60" alt="淘淘"></a></div>
		<!--logo end-->
		<div id="search-2013">
