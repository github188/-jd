...
function login() {
    location.href = "http://sso.taotaocloud.shop/user/login.html";
    return false
}
function regist() {
    location.href = "http://sso.taotaocloud.shop/user/register.html";
    return false
}
(function (a) {
...
function addToFavorite() {
    var a = "http://www.taotaocloud.shop/";
...
<div class="w" id="logo">
    <div>
    	<a href="http://www.taotaocoud.shop/">
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                ...
                href="http://sso.taotaocloud.shop/user/login.html"
