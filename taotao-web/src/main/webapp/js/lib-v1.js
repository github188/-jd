...
var category = {OBJ: $("#_JD_ALLSORT"),
    /*http://manager.taotao.com/web/itemcat/all?callback=category.getDataService*/
		URL_Serv: "http://manager.taotao.com/rest/item/cat/all?callback=category.getDataService",
