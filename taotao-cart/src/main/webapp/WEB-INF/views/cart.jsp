...
<%
	String baseUrl = "http://static.taotaocloud.shop";
...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link href="${baseUrl }/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.taotaocloud.shop/"><img clstag="clickcart|keycount|xincart|logo" src="${baseUrl }/images/taotao-logo.gif" title="返回京东商城首页" alt="返回京东商城首页"></a></div>
          ...
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://www.taotaocloud.shop/order/create.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
...
<script type="text/javascript" src="${baseUrl }/js/base-v1.js"></script>
<!-- footer start -->
...
<script type="text/javascript" src="${baseUrl }/js/jquery.price_format.2.0.min.js"></script>
